...
export default function Cadastro() {
    ...
    const cadastrar = (e) => {
        ...
        fetch("https://freddy-fazbear-pizzaria-backend.vercel.app/produtos", {
            method: "POST",
    ...
    return (
        ...
        <Image alt="asdasd" className="w-full max-w-xs mx-auto" src='https://i.kym-cdn.com/news/posts/original/000/002/303/cover5.jpg'/>
        </div>

        <h1 className="bg-red-500 text-white font-bold font-mono text-5xl p-10 text-center mt-14">FREDDY FAZBEARS PIZZARIA</h1>
